...
if __name__ == "__main__":
    ...
    parser.add_argument('--sync_target_steps', type=int, default=4000, help='number of frames between target network sync, default 4000 steps')
